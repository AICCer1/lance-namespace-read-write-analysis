...
- `examples/probe_namespace_managed_versioning.py`：穿刺验证是否真的走了 namespace-backed version path（`list_table_versions` / `describe_table_version` / `create_table_version`）
